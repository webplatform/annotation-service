...
(function ssoHandlerClosure(window) {
  ...
  SsoHandlerClass.prototype.check = function ssoHandlerCheck() {
    var self = this;
    self.state.username = null;
    self.state.isAnonymous = true;
  ...
  window.sso = new SsoHandlerClass();
})(window);
